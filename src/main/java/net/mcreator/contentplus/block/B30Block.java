...
public class B30Block extends ContentPlusModElements.ModElement {
	@ObjectHolder("content_plus:b_30")
	public static final Block block = null;
	public B30Block(ContentPlusModElements instance) {
		super(instance, 32);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("content_plus:b_30_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("b_30"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("content_plus:b_30"), configuredFeature);
		}
	}
	@SubscribeEvent
