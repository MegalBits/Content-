...
public class B18Block extends ContentPlusModElements.ModElement {
	@ObjectHolder("content_plus:b_18")
	public static final Block block = null;
	public B18Block(ContentPlusModElements instance) {
		super(instance, 20);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("content_plus:b_18_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("b_18"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("content_plus:b_18"), configuredFeature);
		}
	}
	@SubscribeEvent
