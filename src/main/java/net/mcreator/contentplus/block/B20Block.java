...
public class B20Block extends ContentPlusModElements.ModElement {
	@ObjectHolder("content_plus:b_20")
	public static final Block block = null;
	public B20Block(ContentPlusModElements instance) {
		super(instance, 22);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("content_plus:b_20_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("b_20"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("content_plus:b_20"), configuredFeature);
		}
	}
	@SubscribeEvent
