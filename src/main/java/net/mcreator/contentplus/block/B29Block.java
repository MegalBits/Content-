...
public class B29Block extends ContentPlusModElements.ModElement {
	@ObjectHolder("content_plus:b_29")
	public static final Block block = null;
	public B29Block(ContentPlusModElements instance) {
		super(instance, 31);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("content_plus:b_29_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("b_29"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("content_plus:b_29"), configuredFeature);
		}
	}
	@SubscribeEvent
