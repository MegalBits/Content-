...
public class B26Block extends ContentPlusModElements.ModElement {
	@ObjectHolder("content_plus:b_26")
	public static final Block block = null;
	public B26Block(ContentPlusModElements instance) {
		super(instance, 28);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("content_plus:b_26_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("b_26"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("content_plus:b_26"), configuredFeature);
		}
	}
	@SubscribeEvent
