...
public class B21Block extends ContentPlusModElements.ModElement {
	@ObjectHolder("content_plus:b_21")
	public static final Block block = null;
	public B21Block(ContentPlusModElements instance) {
		super(instance, 23);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("content_plus:b_21_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("b_21"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("content_plus:b_21"), configuredFeature);
		}
	}
	@SubscribeEvent
