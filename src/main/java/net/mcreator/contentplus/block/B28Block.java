...
public class B28Block extends ContentPlusModElements.ModElement {
	@ObjectHolder("content_plus:b_28")
	public static final Block block = null;
	public B28Block(ContentPlusModElements instance) {
		super(instance, 30);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("content_plus:b_28_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("b_28"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("content_plus:b_28"), configuredFeature);
		}
	}
	@SubscribeEvent
