...
public class B24Block extends ContentPlusModElements.ModElement {
	@ObjectHolder("content_plus:b_24")
	public static final Block block = null;
	public B24Block(ContentPlusModElements instance) {
		super(instance, 26);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("content_plus:b_24_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("b_24"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("content_plus:b_24"), configuredFeature);
		}
	}
	@SubscribeEvent
