...
public class B23Block extends ContentPlusModElements.ModElement {
	@ObjectHolder("content_plus:b_23")
	public static final Block block = null;
	public B23Block(ContentPlusModElements instance) {
		super(instance, 25);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("content_plus:b_23_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("b_23"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("content_plus:b_23"), configuredFeature);
		}
	}
	@SubscribeEvent
