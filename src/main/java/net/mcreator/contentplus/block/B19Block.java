...
public class B19Block extends ContentPlusModElements.ModElement {
	@ObjectHolder("content_plus:b_19")
	public static final Block block = null;
	public B19Block(ContentPlusModElements instance) {
		super(instance, 21);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("content_plus:b_19_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("b_19"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("content_plus:b_19"), configuredFeature);
		}
	}
	@SubscribeEvent
