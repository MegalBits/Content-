...
public class B6Block extends ContentPlusModElements.ModElement {
	@ObjectHolder("content_plus:b_6")
	public static final Block block = null;
	public B6Block(ContentPlusModElements instance) {
		super(instance, 8);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("content_plus:b_6_match"), () -> CustomRuleTest.codec);
