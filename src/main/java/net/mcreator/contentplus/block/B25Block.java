...
public class B25Block extends ContentPlusModElements.ModElement {
	@ObjectHolder("content_plus:b_25")
	public static final Block block = null;
	public B25Block(ContentPlusModElements instance) {
		super(instance, 27);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("content_plus:b_25_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("b_25"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("content_plus:b_25"), configuredFeature);
		}
	}
	@SubscribeEvent
