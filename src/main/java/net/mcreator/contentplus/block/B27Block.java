...
public class B27Block extends ContentPlusModElements.ModElement {
	@ObjectHolder("content_plus:b_27")
	public static final Block block = null;
	public B27Block(ContentPlusModElements instance) {
		super(instance, 29);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("content_plus:b_27_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("b_27"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("content_plus:b_27"), configuredFeature);
		}
	}
	@SubscribeEvent
