...
public class B22Block extends ContentPlusModElements.ModElement {
	@ObjectHolder("content_plus:b_22")
	public static final Block block = null;
	public B22Block(ContentPlusModElements instance) {
		super(instance, 24);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("content_plus:b_22_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("b_22"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("content_plus:b_22"), configuredFeature);
		}
	}
	@SubscribeEvent
